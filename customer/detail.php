			...
			<table class="table table-hover table-condensed">
				...
				?>
					...
					<tr>
						...
						<td>
							<center><a href="detail.php?add=add&kd1=<?php echo $data['kode']; ?>" class="btn btn-xs btn-success">Add</a> <a href="detail.php?less=less&kd2=<?php echo $data['kode']; ?>" class="btn btn-xs btn-warning">Less</a> <a href="detail.php?aksi=delete&kd=<?php echo $data['kode']; ?>" class="btn btn-xs btn-danger">Delete</a></center>
						</td>
					</tr>
			...
			<div class="row">
				...
				<div class="span2">
					<div id="footer-menu-logo">
						<a href="#"><img src="../img/brand.png" alt="logo" /></a>
					</div>
				</div>
